...
const AllProjects = () => {
  ...
  return (
    <div className='w-full p-5 flex gap-5 h-[90vh] overflow-y-scroll'>
      ...
      <div className='w-[85vw] h-full  p-5 rounded-lg border-2 border-[#2A652E] shadow-lg'>
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 min-h-[200px]'>
              {displayProjects.map(project => (
                <div key={project._id} className='flex'>
                  <div onClick={() => navigate(`/project/${project._id}`)} className='border border-[#2A652E] p-4 rounded-lg flex flex-col flex-1 min-h-[150px] hover:cursor-pointer hover:shadow-lg bg-green-100'>
