...
const AdminProjects = () => {
  ...
  return (
    <div className='page-fill-scroll flex w-full flex-col gap-5 p-3 sm:p-5 lg:flex-row'>
          ...
          <div className='grid min-h-[200px] grid-cols-1 gap-4 overflow-auto scrollbar-hide md:grid-cols-2 lg:grid-cols-3'>
            {displayProjects.map(project => (
              <div key={project._id} className='flex'>
                <div className='theme-card flex h-[260px] max-w-[260px] flex-1 cursor-pointer flex-col overflow-auto rounded-xl p-4 scrollbar-hide'>
                  <h3 className='mb-3 text-lg font-bold'>{project.title.slice(0, 20)}{project.title.length > 20 ? '...' : ''}</h3>
